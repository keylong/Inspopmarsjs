  ...
  const downloadOptions = [
    {
      ...
      features: t('downloadCenter.options.post.features')
    },
    {
      ...
      features: t('downloadCenter.options.stories.features')
    },
    {
      ...
      features: t('downloadCenter.options.reels.features')
    },
    {
      ...
      features: t('downloadCenter.options.igtv.features')
    },
    {
      ...
      features: t('downloadCenter.options.highlights.features')
    },
    {
      ...
      features: t('downloadCenter.options.profile.features')
    }
  ];
