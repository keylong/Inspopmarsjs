...
import type { I18nFunction, TranslationValue } from '@/types/i18n';
  ...
  const downloadOptions = [
    {
      ...
      features: (() => { 
        const data = (t as I18nFunction)('downloadCenter.options.post.features') as TranslationValue; 
        return typeof data === 'object' && !Array.isArray(data) ? Object.values(data) as string[] : Array.isArray(data) ? data : ['HD Quality', 'No Watermark', 'Batch Download']; 
      })()
    },
    {
      ...
      features: (() => { 
        const data = (t as I18nFunction)('downloadCenter.options.stories.features') as TranslationValue; 
        return typeof data === 'object' && !Array.isArray(data) ? Object.values(data) as string[] : Array.isArray(data) ? data : ['Anonymous Download', 'No View Records', '24-hour Content']; 
      })()
    },
    {
      ...
      features: (() => { 
        const data = (t as I18nFunction)('downloadCenter.options.reels.features') as TranslationValue; 
        return typeof data === 'object' && !Array.isArray(data) ? Object.values(data) as string[] : Array.isArray(data) ? data : ['Short Videos', 'Original Quality', 'Fast Download']; 
      })()
    },
    {
      ...
      features: (() => { 
        const data = (t as I18nFunction)('downloadCenter.options.igtv.features') as TranslationValue; 
        return typeof data === 'object' && !Array.isArray(data) ? Object.values(data) as string[] : Array.isArray(data) ? data : ['Long Videos', 'HD Format', 'Stable Download']; 
      })()
    },
    {
      ...
      features: (() => { 
        const data = (t as I18nFunction)('downloadCenter.options.highlights.features') as TranslationValue; 
        return typeof data === 'object' && !Array.isArray(data) ? Object.values(data) as string[] : Array.isArray(data) ? data : ['Curated Content', 'Permanent Storage', 'Batch Processing']; 
      })()
    },
    {
      ...
      features: (() => { 
        const data = (t as I18nFunction)('downloadCenter.options.profile.features') as TranslationValue; 
        return typeof data === 'object' && !Array.isArray(data) ? Object.values(data) as string[] : Array.isArray(data) ? data : ['Avatar Download', 'Profile Pictures', 'Simple & Quick']; 
      })()
    }
  ];
