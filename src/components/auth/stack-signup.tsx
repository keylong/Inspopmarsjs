    ...
    <div className="w-full max-w-md mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="text-sm text-gray-600">
          注册即表示您同意我们的
          <Link href="/zh-CN/terms" className="text-blue-600 hover:text-blue-500">
            服务条款
          </Link>
          和
          <Link href="/zh-CN/privacy" className="text-blue-600 hover:text-blue-500">
            隐私政策
          </Link>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          <button
            ...
            disabled={loading}
            className="flex justify-center py-2 px-4 border border-gray-300 rounded-md bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
          >
